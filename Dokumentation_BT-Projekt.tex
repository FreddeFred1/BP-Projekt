...
\begin{figure}[H] % H: figure wird an dieser Stelle eingefügt
	\centering{ % der Inhalt von figure wird zentriert ausgerichtet
		...
		\caption[Zu enge Rohrdarstellung]
...
Die Variable DB404 Rohrleitung Mischer\_Rohr5 ist ein Integer der aus dem Datenbaustein abgelesen wird. In dem Bereich des Bitwertes von vier bis vier ist diese Rohrleitung sichtbar. Der Wert tritt auf sobald die Förderschnecke und das Ventil zum Mischer aktiv sind. Ist dies nicht der Fall bleibt die Linie unsichtbar.
